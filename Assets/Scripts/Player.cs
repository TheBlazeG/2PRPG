...
public class Player : NetworkBehaviour
{
   ...
   [SerializeField] GameObject character1, character2;
    ...
    private void enableUI(bool oldBool, bool newBool)
    {
        if (!isLocalPlayer)
            return;
    ...
    public void Special1()
    {
        ...
        if (isLocalPlayer&&character2.activeSelf)
        {
